...
$bline = new BLine();
$lineid = $_GET['lid'];
$currentLine = $bline->getLineById($lineid);
...
if(strcmp ( $command, "update" ) == 0){
	...
	$result = $bline->updatelinename($currentLine);
	...
	<div id="page-content" class="container-fluid fixed-width ">
		...
		<div id="signup-page-content">
			<div class="signup-page-container">
				<div class="signup-page-title">修改专线信息</div>
				<div class="signup-page-content">
					<form class="form form-horizontal" id="registerform" method="post"
						action="updateline.php?command=update">
						<input type="hidden" id="lid" name="lid" value="<?php echo $lineid?>"/>
						<?php if($msg != null)
						...
						<div class="control-group">
							...
							<div class="controls input-append">
								<input type="text" id="linename" name="linename" class="input-block-level" value="<?php echo $currentLine->name?>"
