					...
					<form class="form form-horizontal" id="registerform" method="post"
						...
						<div class="control-group">
							...
							<div class="controls input-append">
								<input type="text" id="title" name="title" class="input-block-level" value="<?php echo $currentProduct->title?>"
									placeholder="产品标题">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls input-append">
								<input class="input-block-level required" name="productthumb"
										id="productthumb" type="text" value="<?php echo $currentProduct->photourl?>"
										placeholder="产品图片" />
										<p/>
								<input type="file" name="file1" id="product_image" />
							</div>
						</div>
						<div class="control-group"  id="productview">
								<label class="control-label" data-col-index="1"><span
									class="col-name">预览</span></label>
								<div class="controls input-append">
									<img id="product_img_view" width=100 height=100 class="img-thumbnail" src="<?php echo $currentProduct->photourl?>" alt="photos" />
								</div>
							</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls input-append">
								<input type="text" id="adultprice" name="adultprice" class="input-block-level"
									placeholder=" " value="<?php echo $currentProduct->price?>">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls input-append">
								<input type="text" id="childprice" name="childprice"
									class="input-block-level" placeholder=" " value="<?php echo $currentProduct->childprice?>">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<h6>&nbsp;&nbsp;&nbsp;&nbsp;</h6>
							<script id="editor" name="editor" type="text/plain" style="width:800px;height:500px;" ><?php echo $currentProduct->description?></script>
						</div>
